...
public class Model {
	...
	// Vie total = nombre de cases de tous les b√¢teaux cumul√©s
	...
	public void jouer(ActionEvent source) {
		...
		System.out.println("CoordonnÈes : "+x+" | "+y+"\n");
    	...
    	if (joueur1.coupEstDisponible()) {
    		...
    		if (joueur1.coupEstDisponible() && verif == null)
    			...
    			if (verif != null) {
    				javax.swing.JOptionPane.showMessageDialog(null,verif.getNomJoueur()+" a gagnÈ la partie !");
    				return;
    			}
    		}
    	}
